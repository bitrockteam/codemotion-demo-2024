...
import it.bitrock.fleetdemo.models.Vehicle;
import it.bitrock.fleetdemo.models.VehiclePosition;
...
public class FleetLocationSinkJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AsyncDataStream
                .unorderedWait(platesLocations, new AsyncHttpRequest(GEOLOCATION_URL, API_KEY), 5000, TimeUnit.MILLISECONDS, 320)
